...
--filter-tcp=80,443 --filter-tcp=80,443 --dpi-desync=hostfakesplit --dpi-desync-fooling=badsum,ts --dpi-desync-hostfakesplit-midhost=midsld --hostlist-domains=googlevideo.com --new ^
--filter-tcp=80,443 --filter-tcp=80,443 --dpi-desync=fake,multisplit --dpi-desync-fooling=badsum,ts --dpi-desync-split-pos=1 --dpi-desync-fake-tls=0x4383a71211223344 --dpi-desync-fake-tls=! --dpi-desync-fake-tls-mod=rnd,rndsni,dupsid --hostlist=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-antifilter.txt\" --hostlist=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-rkn.txt\" --hostlist-auto=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-auto.txt\" --hostlist-exclude=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-exclude.txt\" --new ^
