...
--filter-tcp=80,443 --dpi-desync=fake --dpi-desync-fooling=badsum,md5sig,ts --dpi-desync-fake-tls-mod=rnd,dupsid,rndsni,padencap --hostlist-domains=googlevideo.com --new ^
