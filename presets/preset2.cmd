@rem Пресет 2 (multidisorder - googlevideo, fake - HOSTLISTS).
...
--filter-tcp=80,443 --dpi-desync=hostfakesplit --dpi-desync-hostfakesplit-mod=host=www.google.com --dpi-desync-hostfakesplit-mod=altorder=0 --dpi-desync-hostfakesplit-midhost=host-2 --ip-id=seqgroup --dpi-desync-fooling=md5sig --hostlist-domains=googlevideo.com --new ^
--filter-tcp=80,443 --dpi-desync=hostfakesplit --dpi-desync-hostfakesplit-mod=host=www.google.com --dpi-desync-hostfakesplit-mod=altorder=0 --dpi-desync-hostfakesplit-midhost=host-2 --ip-id=seqgroup --dpi-desync-fooling=md5sig --hostlist=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-antifilter.txt\" --hostlist=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-rkn.txt\" --hostlist-auto=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-auto.txt\" --hostlist-exclude=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-exclude.txt\" --new ^
