...
--filter-tcp=80,443 --dpi-desync=fake,fakedsplit --dpi-desync-fooling=badseq --dpi-desync-repeats=20 --dpi-desync-split-pos=1 --dpi-desync-fake-tls=0x00000000 --hostlist-domains=googlevideo.com --new ^
--filter-tcp=80,443 --dpi-desync=fake,fakedsplit --dpi-desync-fooling=badseq --dpi-desync-repeats=20 --dpi-desync-split-pos=1 --dpi-desync-fake-tls=0x00000000 --dpi-desync-fake-tls=! --dpi-desync-fake-tls-mod=rnd,rndsni,dupsid --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\hosts-antifilter.txt\" --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\hosts-rkn.txt\" --hostlist-auto=\"C:\keen_bypass_win\keen_bypass_win\files\hosts-auto.txt\" --hostlist-exclude=\"C:\keen_bypass_win\keen_bypass_win\files\hosts-exclude.txt\" --new ^
