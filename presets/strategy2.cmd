...
--filter-tcp=80,443 --dpi-desync=fake --dpi-desync-fooling=badsum,badseq,md5sig,ts --dpi-desync-fake-tls=0x00000000 --dpi-desync-fake-tls=! --dpi-desync-fake-tls-mod=rnd,rndsni,dupsid --hostlist-domains=googlevideo.com --new ^
