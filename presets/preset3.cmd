...
--dpi-desync=fake,multisplit --dpi-desync-split-pos=1,4,10,sld,midsld,sniext --dpi-desync-fooling=badseq --dpi-desync-badseq-increment=10000 --dpi-desync-fake-tls-mod=rnd,dupsid,sni=fonts.google.com --hostlist-domains=googlevideo.com --new ^
--dpi-desync=fake,multisplit --dpi-desync-split-pos=1,4,10,sld,midsld,sniext --dpi-desync-fooling=badseq --dpi-desync-badseq-increment=10000 --dpi-desync-fake-tls-mod=rnd,dupsid,sni=fonts.google.com --hostlist=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-antifilter.txt\" --hostlist=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-rkn.txt\" --hostlist-auto=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-auto.txt\" --hostlist-exclude=\"C:\ProgramData\keen_bypass_win\keen_bypass\files\hosts-exclude.txt\" --new ^
