...
--filter-tcp=80,443 --dpi-desync=fake,multidisorder --dpi-desync-fooling=md5sig,badsum --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls-mod=rnd,dupsid,sni=lh3.googleusercontent.com --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\list-googlevideo.txt\" --new ^
--filter-tcp=80,443 --dpi-desync=fake,multidisorder --dpi-desync-fooling=badseq,badsum --dpi-desync-split-pos=1,midsld --dpi-desync-fake-tls-mod=rnd,dupsid,sni=lh3.googleusercontent.com --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\list-antifilter.txt\" --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\list-rkn.txt\" --hostlist-auto=\"C:\keen_bypass_win\keen_bypass_win\files\list-auto.txt\" --hostlist-exclude=\"C:\keen_bypass_win\keen_bypass_win\files\list-exclude.txt\" --new ^
--filter-udp=443 --dpi-desync=fake --dpi-desync-repeats=20 --dpi-desync-fake-quic=\"C:\keen_bypass_for_windows\zapret-win-bundle-master\zapret-winws\files\quic_initial_www_google_com.bin\" --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\list-googlevideo.txt\" --new ^
