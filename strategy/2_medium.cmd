@rem 2. Средняя (Подходит к провайдерам где стоят несколько ТСПУ).
...
--filter-tcp=80,443 --dpi-desync=fake,fakeddisorder --dpi-desync-fooling=badseq --dpi-desync-repeats=20 --dpi-desync-fake-tls-mod=rnd,dupsid,sni=lh3.googleusercontent.com --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\list-googlevideo.txt\" --new ^
--filter-tcp=80,443 --dpi-desync=fake,fakeddisorder --dpi-desync-fooling=badseq --dpi-desync-repeats=20 --dpi-desync-fake-tls-mod=rnd,dupsid,sni=lh3.googleusercontent.com --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\list-antifilter.txt\" --hostlist=\"C:\keen_bypass_win\keen_bypass_win\files\list-rkn.txt\" --hostlist-auto=\"C:\keen_bypass_win\keen_bypass_win\files\list-auto.txt\" --hostlist-exclude=\"C:\keen_bypass_win\keen_bypass_win\files\list-exclude.txt\" --new ^
